...
export default function TOC() {
 ...
 return (
   <Nav variant="pills">
     ...
     <NavItem>
       <NavLink href="https://github.com/MaiAnh-KT/kambaz-next-js">My GitHub</NavLink>
     </NavItem>
     <NavItem>
       <NavLink href="https://github.com/MaiAnh-KT/kambaz-node-server-app">My GitHub - Server </NavLink>
     </NavItem>
   </Nav>
);}